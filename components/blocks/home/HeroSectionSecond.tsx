...
const HeroSectionSecond: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative left-1/2 -translate-x-1/2 mx-auto w-screen rounded-xl bg-gradient-to-br from-vina-background via-vina-muted to-vina-background overflow-hidden py-2">
